-- Fix: a_deck_state hat KEINE updated_at Spalte (Schema: user_id/category_id/mode/word_id/last_queued_counter).
-- Unsere A‑SRS Queue-Funktion hat beim mark_queued insert/update trotzdem updated_at geschrieben
-- und ist dadurch hart gecrasht -> "Keine Wörter verfügbar".
