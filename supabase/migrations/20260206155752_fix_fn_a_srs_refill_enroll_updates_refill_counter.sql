-- Fix: fn_a_srs_refill_enroll muss category_refill_state.refill_counter aktualisieren
-- Das Problem: Die Queue-Funktion holt den refill_counter aus category_refill_state,
-- aber die Refill-Funktion aktualisiert diese Tabelle nicht. Daher verwendet die
-- Queue-Funktion einen alten refill_counter Wert und findet die neu enrollierten Wörter nicht.
...
begin
  ...
  -- FIX: Aktualisiere category_refill_state.refill_counter, damit die Queue-Funktion den richtigen Wert verwendet
