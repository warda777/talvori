...
abstract class WordRepository {
  Future<List<Word>> fetchByFilter(WordListFilter filter, {int limit = 50, int offset = 0});
...
class MockWordRepository implements WordRepository {
  ...
  @override
  Future<List<Word>> fetchByFilter(WordListFilter filter, {int limit = 50, int offset = 0}) async {
