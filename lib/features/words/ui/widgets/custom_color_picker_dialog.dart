...
enum ColorFormat { hex, rgb, css, hsl, hsb }
...
class _CustomColorPickerDialogState extends State<CustomColorPickerDialog> {
  ...
  final ScrollController _scrollController =
      ScrollController(); // ScrollController für Farbpalette
    ...
    return Dialog(
      ...
      child: Container(
        ...
        constraints: const BoxConstraints(
          maxHeight: 700,
        ), // Höhe erhöht für mehr Scroll-Platz
                  ...
                  children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 13,
                              fontFamily: _colorFormat == ColorFormat.hex
                                  ? 'monospace'
                                  : null,
                            ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height:
                              104, // Genau 3 Reihen: (24px + 8px spacing) * 3 = 96px, plus 8px für bessere Sichtbarkeit
                          child: Scrollbar(
                            controller: _scrollController,
                            thumbVisibility:
                                false, // Scrollbar nur beim Scrollen sichtbar
                            thickness: 6,
...
class _ColorGradientFieldState extends State<_ColorGradientField> {
  ...
  final double _containerHeight = 200.0; // Container-Höhe ist fest
          ...
          return Container(
            ...
            child: Stack(
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [Colors.white, baseColor, Colors.black],
                ...
                Positioned(
                  left: (widget.saturation * _containerWidth - 10).clamp(
                    0.0,
                    _containerWidth - 20,
                  ),
                  top: ((1 - widget.lightness) * _containerHeight - 10).clamp(
                    0.0,
                    _containerHeight - 20,
                  ),
                  child: Container(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          if (constraints.maxWidth.isFinite &&
              constraints.maxWidth != _sliderWidth) {
            WidgetsBinding.instance.addPostFrameCallback((_) {
              if (mounted) {
                setState(() {
          ...
          return Container(
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  left: ((widget.hue / 360.0) * _sliderWidth - 12).clamp(
                    0.0,
                    _sliderWidth - 24,
                  ),
                  top: 0,
          ...
          return Container(
            ...
            child: Stack(
              children: [
                ...
                // Positioned muss direkt im Stack sein
                Positioned(
                  left: ((1 - widget.alpha) * _sliderWidth - 12).clamp(
                    0.0,
                    _sliderWidth - 24,
                  ),
                  top: 0,
