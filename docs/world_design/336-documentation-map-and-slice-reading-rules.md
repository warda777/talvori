...
| `405-italy-shape-source-of-truth-gate.md` | Italien-Kontur Source-of-Truth Gate: Pflicht fuer kommende Italy-/Italien-/Kontur-/Shape-/Source-of-Truth-/World-/Map-Slices, wenn die echte Italien-Aussenkontur, Natural Earth, OSM-Kandidaten, Lizenz-/Attributionsgrenzen, Festland/Sizilien/Sardinien, Nebeninseln, Konturvereinfachung oder Trennung zwischen echter Form, Dokumentationskontur, Greybox und Runtime betroffen sind. 405 gibt keine Konturdatei, SVG/PNG, Bilder, Assets, Runtime-Daten, Koordinaten, YAML/JSON oder Code frei. |
| `406-italy-working-contour-visual-gate.md` | Italien-Arbeitskontur Visual Gate: Pflicht fuer kommende Italy-/Italien-/Blockout-/Greybox-/World-/Map-Slices, wenn die Natural-Earth-basierte Arbeitskontur, Festland/Sizilien/Sardinien, Mobile-Vereinfachung, Dokumentations-SVG/PNG, Metadata oder Folgeplanung fuer Wege, Wasser, Bauflaechen, No-Walk/No-Build oder technische Layer betroffen sind. 406 und der Preview-Ordner sind keine Asset-, Runtime-, Engine-ready-, YAML-/JSON-, App- oder `assets/`-Freigabe. |
| `previews/italy_shape_working_contour/` | Italien-Arbeitskontur Preview-Ordner: enthaelt `italy_shape_working_contour.svg`, `italy_shape_working_contour.png` und Metadata als `documentation_only`, `not_asset`, `not_runtime_data`, `not_engine_ready`; Pflichtgrundlage fuer kommende Italien-Makro-Blockout-, Greybox- und World-Layout-Slices. |
| `407-italy-macro-blockout-paths-water-buildareas.md` | Italien-Makro-Blockout Gate: Pflicht fuer kommende Italy-/Italien-/Layer-/Mask-/Greybox-/World-/Map-Slices, wenn Wege, Wasser/Kueste, Uebergaenge, organische Bauflaechen, Reserveflaechen, No-Walk/No-Build oder Makro-Blockout-Folgeplanung betroffen sind. 407 und der Preview-Ordner sind keine Asset-, Runtime-, Engine-ready-, YAML-/JSON-, App- oder `assets/`-Freigabe. |
| `previews/italy_macro_blockout_paths_water_buildareas/` | Italien-Makro-Blockout Preview-Ordner: enthaelt SVG, PNG und Metadata fuer das sichtbare Blockout mit 13 organischen Bauflaechen, 6 Startflaechen, Wegen, Wasser/Kueste, Uebergaengen und groben Schutzraeumen; Pflichtgrundlage fuer kommende technische Layer-/Masken-, Greybox- und World-Layout-Slices. |
| `408-italy-city-anchor-plan.md` | Italien-Stadtanker-Plan: Pflicht fuer kommende Italy-/Italien-/Blockout-/Greybox-/World-/Map-Slices, wenn Stadtanker, Stadtrollen, Wegeausrichtung, Bauflaechen-Ausrichtung, Wasser-/Uebergangslogik, Natural Earth Populated Places, OSM-/ISTAT-Kandidaten oder die Ueberarbeitung von 407 betroffen sind. 408 gibt keine finalen Koordinaten, Runtime-Stadtpunkte, YAML/JSON, Assets, Code oder App-Integration frei. |
| `409-europe-country-city-zoom-architecture-gate.md` | Europa-Land-/Stadt-Zoom-Architektur: Pflicht fuer kommende Europe-/Europa-/Country-/Land-/City-/Stadt-/Zoom-/World-/Map-/Build-Slices, wenn Europa-Overview, Land-Auswahl, Country Profile, Laenderkonturen, Stadtanker, Stadtgrundformen, city footprint sources, playable city areas oder die Uebertragung von Italien auf weitere Laender betroffen sind. 409 gibt keine Runtime-Daten, YAML/JSON, Assets, Code oder App-Integration frei. |
| `410-italy-city-footprints-istat-comuni-gate.md` | Italien-Stadtgrundformen aus ISTAT-Comuni: Pflicht fuer kommende Italy-/Italien-/City-/Stadt-/Footprint-/Playable-City-Area-/World-/Map-Slices, wenn ISTAT Comuni, Gemeindegrenzen, Stadtgrundformen, `PRO_COM_T`, Namensmatching, spielbare Stadtbereiche oder die Ableitung aus echten Stadt-/Gemeindegrenzen betroffen sind. 410 gibt keine Runtime-Polygone, Collision, Build-Zones, Pathfinding, YAML/JSON, Assets, Code oder App-Integration frei. |
| `previews/italy_city_footprints_istat_comuni/` | Italien-Stadtgrundformen Preview-Ordner: enthaelt SVG, PNG und Metadata fuer 13 ISTAT-Comuni-Footprints als `documentation_only`, `not_asset`, `not_runtime_data`, `not_engine_ready`; Pflichtgrundlage fuer kommende Italien-Spielbare-Stadtbereiche-, Stadt-Blockout- und City-Zoom-Slices. |
| `411-italy-playable-city-areas-from-footprints.md` | Italien spielbare Stadtbereiche aus Stadtgrundformen: Pflicht fuer kommende Italy-/Italien-/City-/Stadt-/Playable-City-Area-/Stadt-Blockout-/Greybox-/World-/Map-Slices, wenn echte ISTAT-Comuni-Footprints in Talvori-gerechte Stadtbereiche, Stadtkern, Reserve, Rand/No-Build, Start-Bauplatz, Core-/Reserve-Stadtgewichtung oder Stadt-Greybox-Folgearbeit uebersetzt werden. 411 gibt keine Runtime-Polygone, finalen Koordinaten, Build-Zones, No-Walk-/No-Build-Masken, YAML/JSON, Assets, Code oder App-Integration frei. |
| `previews/italy_playable_city_areas_from_footprints/` | Italien spielbare Stadtbereiche Preview-Ordner: enthaelt SVG, PNG und Metadata fuer 13 abstrahierte `playable_city_area`-Kandidaten aus ISTAT-Comuni-Footprints als `documentation_only`, `not_asset`, `not_runtime_data`, `not_engine_ready`; Pflichtgrundlage fuer kommende Italien-Stadtbereich-Review-, Stadt-Blockout- und City-Greybox-Slices. |
| `412-italy-playable-city-area-review-and-first-city-decision.md` | Italien Playable-City-Area Review und erste Stadtentscheidung: Pflicht fuer kommende Italy-/Italien-/City-/Stadt-/Greybox-/Blockout-/World-/Map-Slices, wenn die erste Stadt-Greybox, Firenze, Roma/Bologna als Reserve, Stadtbereich-Risiko, Build-/Wege-/Kamera-/Lernort-Potenzial oder Stadt-Greybox-Folgeplanung betroffen ist. 412 entscheidet Firenze als ersten Stadt-Greybox-Kandidaten und gibt keine Runtime-Daten, finalen Koordinaten, YAML/JSON, Assets, Code oder App-Integration frei. |
| `413-world-travel-zoom-navigation-gameflow-gate.md` | World-Travel Zoom Navigation Gameflow Gate: Pflicht fuer kommende World-/Globus-/Europa-/Italy-/Italien-/Country-/City-/Stadt-/Zoom-/Navigation-/Greybox-/Preview-Slices, wenn der Flow Globus -> Europa -> Italien -> Firenze, locked/ausgegraute Laender, Stadtanker als lebendige Orte, Tali/Vori-Begleitung, 411/412-UI-Abgrenzung oder spielartige Map-Navigation betroffen ist. 413 gibt keine Runtime-Daten, finalen Koordinaten, YAML/JSON, Assets, Code oder App-Integration frei. |
| `414-world-travel-preview-fail-review-and-source-based-rebuild-plan.md` | World-Travel Preview Fail Review: Pflicht fuer kommende World-Travel-/Globus-/Europa-/Laender-/Italien-/Firenze-/Zoom-/Preview-/Implementation-Slices, wenn echte Konturen, source-based Preview, Globus-/Laenderformen, Italien-Erkennbarkeit oder der Neuaufbau nach der abgelehnten freien Preview betroffen sind. 414 verbietet frei gemalte Laender-/Globus-/Stadtformen, wenn offene Source-Konturen verfuegbar sind, und gibt keine neue Preview-, Code-, Asset-, Runtime-, YAML-/JSON- oder App-Freigabe. |
...
Nach M16-DP muss bei jedem M16-DQ-Measurement-/Value-Gate, jeder
Skeleton-Korrektur, jeder ersten echten Wertoeffnung, jeder
Geometrie-/Koordinaten-/Path-/Union-Grenzentscheidung und jeder Runtime-
naeheren Uferwald-Planungsarbeit zusaetzlich
`399-uferwald-yaml-planning-skeleton-review.md` gelesen werden. 399
entscheidet, dass M16-DO ausreichend ist und kein M16-DO-FIX noetig ist.
Ein Measurement-/Value-Gate darf vorbereitet werden, aber echte Werte,
Runtime-Daten, finale Koordinaten, Polygone, Path-Centerlines, Path-Nodes,
Path-Edges, Build-Zonen-Polygone, Plot-Footprint-Polygone, No-Walk-/No-
Build-Unionen als echte Werte, Pixelableitung, Assets, Flutter-Code und
App-Integration bleiben bis zu eigener, enger Folgefreigabe geschlossen.

Nach M16-DQ muss bei jedem M16-DR-Anchor-Review-Values-Gate, jeder
Wertfamilien-Oeffnung, jeder Anchor-Rollen-/Statuswert-Planung, jeder
YAML-Wertvertragsentscheidung und jeder Runtime-naeheren Uferwald-Value-
Arbeit zusaetzlich `400-uferwald-measurement-value-gate-preparation.md`
gelesen werden. 400 empfiehlt `anchor_review_values` als erste spaeter
oeffnungsfaehige Wertfamilie, aber nur fuer Rollen-, Modus-, Status- und
QA-Werte ohne Koordinaten. M16-DR bleibt Markdown-only. Die bestehende YAML
darf ohne spaeteren expliziten Folgeprompt nicht geaendert werden; echte
Werte, Runtime-Daten, Koordinaten, Polygone, Path-Centerlines, Path-Nodes,
Path-Edges, No-Walk-/No-Build-Unionen, Pixelableitung, Assets, Flutter-Code
und App-Integration bleiben geschlossen.

Nach M16-DR muss bei jedem M16-DS-YAML-Update-Gate, jeder
`anchor_review_values`-Wertoeffnung, jeder Anchor-ID-Vertragsarbeit, jeder
Rollen-/Modus-/QA-Enum-Aenderung und jeder Runtime-naeheren Anchor-
Planungsarbeit zusaetzlich `401-uferwald-anchor-review-values-gate.md`
gelesen werden. 401 definiert nur den Markdown-Feldvertrag fuer
`anchor_review_values`. Eine Aenderung der bestehenden Skeleton-YAML ist erst
in einem spaeteren M16-DS-Prompt erlaubt, wenn exakt ein Pfad, genau eine
Wertfamilie, die erlaubten Felder, der Statusschutz und harte Datei-/Scope-
...
### 5.3 Italien-Kontur Source-of-Truth Pflichtregel

`405-italy-shape-source-of-truth-gate.md` ist Pflicht fuer kommende Italy-,
Italien-, Kontur-, Shape-, Source-of-Truth-, World- oder Map-Slices, wenn die
echte Italien-Aussenkontur, Natural Earth, OpenStreetMap-Kandidaten,
Lizenz-/Attributionsgrenzen, Festland/Sizilien/Sardinien, Nebeninseln,
Konturvereinfachung, Dokumentationskontur, Greybox oder Runtime-Abgrenzung
betroffen sind.

405 muss vor jeder echten Konturarbeit angewendet werden:

1. Erst 405 pruefen: Ist Quelle, Lizenz, Attribution und erlaubte
   Vereinfachung klar?
2. Danach 404 pruefen: Passt der Schritt in die Italien-Produktionsreihenfolge
   und bleibt es ein sprechender Slice?
3. Danach 403/384/385 pruefen: Bleibt das Ergebnis spielnah, fullscreen/
   near-fullscreen und technisch sauber von Runtime-Daten getrennt?

Stop-Regel:

- Kein Folge-Slice darf fremde Kartenbilder, Screenshots, Kartenkacheln,
  Google Maps, Apple Maps, Pinterest, Luftbilder oder Atlasbilder kopieren
  oder nachzeichnen.
- Kein Folge-Slice darf eine Konturdatei, SVG/PNG, YAML/JSON/YML,
  Runtime-Koordinaten, Polygone, Assets oder Code erzeugen, wenn dies nicht
  durch ein eigenes Folge-Gate ausdruecklich freigegeben ist.
- Natural Earth ist die bevorzugte erste Source-of-Truth-Empfehlung; OSM
  bleibt nur Kandidat mit separater Lizenz-/Attributionspruefung.
- 405 gibt keine Konturdatei, Bild-, Asset-, Runtime-, YAML-/JSON-, App-,
  Route-, Persistenz-, BuildState- oder `assets/`-Freigabe.

### 5.4 Italien-Arbeitskontur Visual Pflichtregel

`406-italy-working-contour-visual-gate.md` und
`previews/italy_shape_working_contour/` sind Pflicht fuer kommende Italy-,
Italien-, Blockout-, Greybox-, World- oder Map-Slices, wenn die sichtbare
Italien-Arbeitskontur, Festland/Sizilien/Sardinien, mobile Vereinfachung,
Dokumentations-SVG/PNG, Metadata, Wege, Wasser, Bauflaechen, No-Walk/No-Build,
Anchors oder technische Layer-Folgeplanung betroffen sind.

406 muss nach 405 und vor jedem Italien-Makro-Blockout angewendet werden:

1. Erst 405 pruefen: Natural Earth bleibt die geklaerte Source of Truth.
2. Danach 406 pruefen: Die sichtbare Arbeitskontur ist nur
   Dokumentationsvisual und keine Runtime-Geometrie.
3. Danach 403/384/385 pruefen: Blockout, Wege, Bauflaechen, No-Walk/No-Build
   und Layer muessen spielnah und technisch getrennt geplant werden.

Stop-Regel:

- Kein Folge-Slice darf die SVG-ViewBox-Koordinaten als finale Koordinaten,
  produktive Polygone oder Runtime-Mapdaten verwenden.
- Kein Folge-Slice darf `italy_shape_working_contour.svg` oder `.png` als
  Asset, Engine-ready Candidate, finales Spielbild oder App-Screen behandeln.
- PNG/SVG aus diesem Gate bleiben ausschliesslich unter
  `docs/world_design/previews/italy_shape_working_contour/`.
- 406 gibt keine Asset-, Runtime-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.5 Italien-Makro-Blockout Pflichtregel

`407-italy-macro-blockout-paths-water-buildareas.md` und
`previews/italy_macro_blockout_paths_water_buildareas/` sind Pflicht fuer
kommende Italy-, Italien-, Layer-/Mask-, Greybox-, World- oder Map-Slices,
wenn Wege, Wasser/Kueste, Uebergaenge, organische Bauflaechen,
Reserveflaechen, No-Walk/No-Build, Anchors oder technische Layer-Folgeplanung
betroffen sind.

407 muss nach 406 und vor technischen Layer-/Masken- oder Greybox-Folgearbeit
angewendet werden:

1. Erst 406 pruefen: Die Arbeitskontur bleibt Source-Visual, kein Asset und
   keine Runtime-Geometrie.
2. Danach 407 pruefen: Wege, Bauflaechen, Wasser und Schutzraeume sind als
   Blockout sichtbar, aber noch keine technischen Daten.
3. Danach 384/385 pruefen: Technische Layer, Masks, Zonen, Pfade und Anchors
   muessen separat geplant werden, bevor Runtime-Naehe entsteht.

Stop-Regel:

- Kein Folge-Slice darf die 407-Overlays als finale Koordinaten, produktive
  Polygone, Runtime-Pfade, Collision, Build-Zonen oder App-Daten verwenden.
- Kein Folge-Slice darf die PNG/SVG-Dateien als Asset, Engine-ready Candidate,
  finales Spielbild oder App-Screen behandeln.
- 407 gibt keine Asset-, Runtime-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.6 Italien-Stadtanker Pflichtregel

`408-italy-city-anchor-plan.md` ist Pflicht fuer kommende Italy-, Italien-,
Blockout-, Greybox-, World- oder Map-Slices, wenn Stadtanker, Stadtrollen,
Wegeausrichtung, Bauflaechen-Ausrichtung, Wasser-/Uebergangslogik, Rom,
Florenz, Venedig, Mailand, Neapel, Bologna, Palermo, Catania, Cagliari,
Natural Earth Populated Places oder die Ueberarbeitung von 407 betroffen sind.

408 muss vor der naechsten Blockout-Ueberarbeitung angewendet werden:

1. Erst 408 pruefen: Welche Stadtanker sind sofort wichtig, welche Reserve?
2. Danach 407 pruefen: Was muss am abstrakten Makro-Blockout neu ausgerichtet
   werden?
3. Danach 406/405 pruefen: Die Arbeitskontur und Source-of-Truth-Grenzen
   bleiben fuehrend.

Stop-Regel:

- Kein Folge-Slice darf Stadtanker als finale Runtime-Koordinaten,
  Stadtpunkt-Datei, JSON/YAML/YML, App-Daten oder produktive Polygone
  verwenden.
- Madrid und andere Nicht-Italien-Stadtanker duerfen fuer diesen Prototyp
  nicht aufgenommen werden.
- OSM oder ISTAT duerfen ohne eigenes Lizenz-/Attributionsgate nicht als
  Datenquelle uebernommen werden.
- 408 gibt keine Asset-, Runtime-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.7 Europa-Land-/Stadt-Zoom Pflichtregel

`409-europe-country-city-zoom-architecture-gate.md` ist Pflicht fuer kommende
Europe-, Europa-, Country-, Land-, City-, Stadt-, Zoom-, World-, Map- oder
Build-Slices, wenn Europa-Overview, Land-Auswahl, Country Profile,
Laenderkonturen, Stadtankerquellen, Stadtgrundformen, city footprint sources,
playable city areas, Bauflaechen, Wege, No-Walk/No-Build oder die
Uebertragung von Italien auf weitere europaeische Laender betroffen sind.

409 muss vor neuen laender- oder stadtspezifischen Ableitungen angewendet
werden:

1. Erst 409 pruefen: Ist die Arbeit generisch fuer Europa/Land/Stadt
   gedacht und nicht nur als Italien-Sonderarchitektur?
2. Danach landesspezifische Gates pruefen: Fuer Italien sind das aktuell
   404, 405, 406, 407 und 408; fuer andere Laender muss ein eigenes
   Quellen-/Lizenz-/Abstraktionsgate entstehen.
3. Danach erst duerfen sichtbare Blockouts, technische Layer/Masks oder
   spaetere Interaktions-Slices vorbereitet werden.

Stop-Regel:

- Kein Folge-Slice darf eine reine Italien-Sonderarchitektur bauen, wenn die
  betroffene Logik spaeter fuer weitere europaeische Laender gelten muss.
- Natural Earth Admin 0 bleibt geeigneter Standardkandidat fuer
  Laenderkonturen; Natural Earth Populated Places bleibt geeigneter erster
  Stadtanker-Kandidat, aber beides wird nicht automatisch Runtime-Daten.
- Stadt-/Gemeindegrenzen muessen pro Land aus passenden amtlichen/open-data
  Quellen geprueft werden; fuer Italien ist ISTAT Comuni der naechste
  Kandidat, aber noch nicht uebernommen.
- OSM, OpenMapTiles, MapTiler, free-map.org oder aehnliche Tool-/Datenquellen
  duerfen ohne eigenes Lizenz-, Attribution-, Nutzungs- und Repo-Grenzen-Gate
  nicht uebernommen werden.
- Kartenbilder, Screenshots, Tiles, Google Maps, Apple Maps, Pinterest,
  Atlasbilder oder Luftbilder duerfen nicht kopiert, nachgezeichnet oder als
  Source of Truth verwendet werden.
- 409 gibt keine Runtime-Daten, finalen Koordinaten, Polygone, YAML-/JSON-
  Dateien, Assets, App-Code, Route, Persistenz, BuildState oder `assets/`-
  Freigabe.

### 5.8 Italien-Stadtgrundformen / ISTAT-Comuni Pflichtregel

`410-italy-city-footprints-istat-comuni-gate.md` und
`previews/italy_city_footprints_istat_comuni/` sind Pflicht fuer kommende
Italy-, Italien-, City-, Stadt-, Footprint-, Playable-City-Area-, World-,
Map- oder Build-Slices, wenn ISTAT Comuni, italienische Gemeindegrenzen,
Stadtgrundformen, `PRO_COM_T`, Namensmatching, spielbare Stadtbereiche,
Stadt-Blockout oder die Ableitung aus echten Comune-Umrissen betroffen sind.

410 muss vor jeder spielbaren-Stadtbereich-Ableitung angewendet werden:

1. Erst 410 pruefen: Ist ISTAT Comuni als Quelle sauber dokumentiert und
   bleibt CC-BY-4.0-Attribution sichtbar?
2. Danach das Preview-Visual pruefen: Die 13 Footprints sind
   Dokumentationsformen, keine Runtime-Polygone.
3. Danach erst duerfen Talvori-gerechte `playable_city_area`-Kandidaten aus
   den echten Umrissen abstrahiert werden.

Stop-Regel:

- Kein Folge-Slice darf die ISTAT-Umrisse als finale Runtime-Koordinaten,
  Collision, Build-Zones, Pathfinding, Path-Centerlines, No-Walk/No-Build,
  YAML/JSON/YML, App-Daten oder Assets verwenden.
- Deutsches/englisches Stadtlabel-Matching muss auf exakte ISTAT-`COMUNE`-
  Namen und `PRO_COM_T`-Kontrolle zurueckgefuehrt werden; unsicheres
  Substring-Matching ist blockiert.
- Generalisierte ISTAT-Grenzen sind fuer erste Talvori-Reviews bevorzugt;
  nicht-generalisierte Grenzen brauchen ein eigenes Detail-Review.
- Die naechste fachliche Arbeit muss spielbare Stadtbereiche abstrahieren,
  nicht echte Comune-Polygone produktiv uebernehmen.
- 410 gibt keine Runtime-, Asset-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.9 Italien-Spielbare-Stadtbereiche Pflichtregel

`411-italy-playable-city-areas-from-footprints.md` und
`previews/italy_playable_city_areas_from_footprints/` sind Pflicht fuer
kommende Italy-, Italien-, City-, Stadt-, Playable-City-Area-, Stadt-Blockout-,
Greybox-, World-, Map- oder Build-Slices, wenn ISTAT-Footprints in
Talvori-gerechte Stadtbereiche, Stadtkern, Reserveflaechen, Rand/No-Build,
Start-Bauplaetze oder Core-/Reserve-Gewichtung uebersetzt werden.

411 muss vor jeder Stadt-Greybox oder Stadtbereich-Folgearbeit angewendet
werden:

1. Erst 410 pruefen: Die echten ISTAT-Comuni-Grenzen sind nur Source-
   Footprints.
2. Danach 411 pruefen: Spielbare Stadtbereiche sind abstrahierte Kandidaten,
   keine echten Grenzen.
3. Danach erst duerfen Wege, Baupunkte, Wasser, No-Walk/No-Build oder
   Interaktions-Greyboxes fuer Staedte geplant werden.

Stop-Regel:

- Kein Folge-Slice darf ISTAT-Footprints oder 411-Kandidaten als finale
  Runtime-Polygone, Koordinaten, Collision, Build-Zones, Pathfinding,
  Path-Centerlines, No-Walk-/No-Build-Masken, YAML/JSON/YML, App-Daten oder
  Assets verwenden.
- Jede spielbare Stadtbereichsplanung braucht mindestens Stadtkern,
  Reserveflaeche, Rand/No-Build und moeglichen Start-Bauplatz.
- Kernstaedte duerfen staerker priorisiert werden; Reserve-Staedte muessen
  sichtbar bleiben, duerfen aber den ersten Greybox-Fokus nicht ueberladen.
- 411 gibt keine Runtime-, Asset-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.10 Italien-Erste-Stadt-Greybox Entscheidungsregel

`412-italy-playable-city-area-review-and-first-city-decision.md` ist Pflicht
fuer kommende Italy-, Italien-, City-, Stadt-, Greybox-, Blockout-, World-,
Map- oder Build-Slices, wenn die erste Stadt-Greybox, Firenze, Roma/Bologna
als Reserve, Stadtbereich-Risiko, Build-Flaechen, Wege, Kamera, Lernorte oder
die Ableitung aus `playable_city_area` betroffen sind.

412 muss vor der ersten Stadt-Greybox angewendet werden:

1. Erst 411 pruefen: Der Stadtbereich ist ein abstrahierter Kandidat, kein
   Runtime-Polygon.
2. Danach 412 pruefen: Firenze ist die erste Stadt; Roma und Bologna bleiben
   Reserve-Kandidaten.
3. Danach erst duerfen sichtbare Greybox-Planung, Baupunkte, Wege,
   Lernorte, Kamera- und HUD-Grenzen fuer Firenze vorbereitet werden.

Stop-Regel:

- Kein Folge-Slice darf Roma, Milano, Venezia, Bologna oder Napoli ohne neues
  Entscheidungs-Review anstelle von Firenze als erste Stadt einsetzen.
- Kein Folge-Slice darf Firenze 1:1 aus ISTAT-Footprint oder 411-Visual als
  Runtime-Koordinaten, produktive Polygone, Collision, Pathfinding,
  Build-Zones, No-Walk-/No-Build-Masken, YAML/JSON/YML, App-Daten oder Assets
  uebernehmen.
- Die erste Firenze-Greybox muss spielartig, nicht GIS-/Atlas-/Dashboard-
  oder Debug-artig gedacht werden.
- 412 gibt keine Runtime-, Asset-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.11 World-Travel Zoom Gameflow Pflichtregel

`413-world-travel-zoom-navigation-gameflow-gate.md` ist Pflicht fuer kommende
World-, Globus-, Europa-, Italy-, Italien-, Country-, City-, Stadt-, Zoom-,
Navigation-, Greybox- oder Preview-Slices, wenn der Flow von Welt zu Land zu
Stadt, locked/ausgegraute Laender, Italien als erstes aktives Land, Firenze
als erster City-Zoom, Stadtanker als lebendige Orte, Tali/Vori-Begleitung oder
die Abgrenzung von 411/412 als Nicht-App-Screens betroffen ist.

413 muss vor jedem produktiven Navigations-Prototyp angewendet werden:

1. Erst 409 pruefen: Der Flow bleibt Europa-/Land-/Stadt-faehig und nicht
   Italien-Sonderarchitektur.
2. Danach 411/412 pruefen: Stadtbereiche und Firenze-Entscheidung sind
   Backstage-Dokumentation, keine UI.
3. Danach 413 pruefen: Der Ziel-Flow ist Globus -> Europa -> Italien ->
   Firenze -> Bauflaechen/Lernorte.

Stop-Regel:

- Kein Folge-Slice darf das 411-Visual als iPhone-Screen uebernehmen.
- Keine World-Travel-Preview darf wie GIS, Atlas, Google Maps, Dashboard,
  Debug-Tool oder Kartenliste wirken.
- Andere Laender muessen als spaeterer Kontext sichtbar, locked oder
  ausgegraut gedacht werden, sofern eine Europa-/Landansicht betroffen ist.
- Italien bleibt erstes aktives Land; Firenze bleibt erster City-Zoom, solange
  kein neues Review diese Entscheidung aendert.
- Tali/Vori darf begleiten, aber nicht die Welt-/Land-/Stadt-Interaktion
  durch ein Menue ersetzen.
- 413 gibt keine Runtime-, Asset-, YAML-/JSON-, App-, Route-, Persistenz-,
  BuildState- oder `assets/`-Freigabe.

### 5.12 World-Travel Source-Based Rebuild Pflichtregel

`414-world-travel-preview-fail-review-and-source-based-rebuild-plan.md` ist
Pflicht fuer kommende World-Travel-, Globus-, Europa-, Laender-, Italien-,
Firenze-, Zoom-, Preview- oder Implementierungs-Slices, wenn nach der
abgelehnten ersten isolierten Preview ein neuer sichtbarer World-Travel-Flow
entsteht.

414 muss vor jedem neuen World-Travel-Preview-Code oder -Visual angewendet
werden:

1. Erst 413 pruefen: Der Ziel-Flow bleibt Globus -> Europa -> Italien ->
   Firenze -> Bauflaechen/Lernorte.
2. Danach 414 pruefen: Globus, Europa, Laender, Italien und Stadtziele duerfen
   nicht frei gemalt werden, wenn echte offene Konturgrundlagen vorhanden
   oder bereits im Repo dokumentiert sind.
3. Danach 405/406 und bei Firenze 410/411/412 pruefen: Italien und
   Stadtkontext kommen aus Source-of-Truth-/Footprint-/Review-Linie, bleiben
   aber `not_runtime_data`.

Stop-Regel:

- Keine neue World-Travel-Preview ist commitfaehig, wenn Erde, Europa,
  Laender, Italien oder Firenze als frei erfundene Blob-/Fantasieformen
  entstehen.
- Italien muss als Italien erkennbar bleiben und aus der vorhandenen
  Natural-Earth-/406-Source-Linie abgeleitet werden.
- 411/412 bleiben Backstage-Dokumentation und duerfen nicht als App-Screen
  kopiert werden.
- Source-based bedeutet nicht GIS-/Atlas-Look: echte Formen sind Grundlage,
  die sichtbare Preview muss trotzdem spielartig, fullscreen/near-fullscreen
  und HUD-arm bleiben.
...
kommende City-, Stadt-, Island-, Insel-, District-, Plot-Focus-, Playable-Area-,
Build-Slot-, Walkability-, Collision-, No-Walk-, No-Build-, Anchor- oder
Greybox-Slices, sobald eine Flaeche als betretbar, baubar, navigierbar oder
spielbar geplant wird.

416 muss vor jeder neuen spielbaren Flaechen-Preview angewendet werden:

1. Zuerst `area_identity`, `coordinate_system` und `metrics_v1` klaeren.
2. Danach Boundary, Terrain, Water, Paths und Build Slots als abgeleitete
   Planungsfamilien pruefen.
3. Fuer konkrete City-/Island-/District-/Plot-Focus-Flaechen zusaetzlich den
   Area Layout Blueprint liefern: geplante Parcel-Anzahl, Parcel-Substruktur,
   vollstaendiges Wegenetz inklusive future/reserve paths, Parcel Access,
   Visibility-Status und Visual Blueprint.
4. Danach Occupancy, Collision, Navigation/Walkability, No-Walk, No-Build,
   Anchors, Semantic Zones, Source Traceability und Visual-QA dokumentieren.

Stop-Regel:

- Keine spielbare Stadt-/Insel-/District-/Plot-Focus-Preview ist
  commitfaehig, wenn sie ohne Area Specification entsteht.
- Keine Build-Slots ohne Boundary, Path Access, No-Build, Occupancy,
  Collision und No-Overlap-Check.
- Keine konkrete spielbare Flaeche ohne geplante Grundstuecksanzahl,
  innere Parcel-Struktur, complete path network plan und Future-Visibility-
  Regel.
- Keine Stadtansicht ohne Walkability-/Reachability-Review.
- 416 gibt keine Runtime-, YAML-/JSON-/YML-, Flutter-/Dart-, Asset-,
  App-Route-, Persistenz- oder BuildState-Freigabe.

### 5.14 Firenze Ground-/Layer-/Anchor Pflichtregel

`415-firenze-playable-city-ground-layer-and-anchors-gate.md` ist Pflicht fuer
kommende Firenze-/Florenz-/City-Entry-/City-Ground-/Greybox-/Buildable-Ground-,
Path-, River-, Bridge-, No-Walk-, No-Build-, Landmark- oder Start-Anchor-Slices.

415, 416 und 417 muessen vor jeder neuen Firenze-City-Entry-App-Preview
angewendet werden:

1. Erst 410 pruefen: Firenze kommt aus ISTAT Comuni 2026,
   `PRO_COM_T=048017`; diese Quelle ist Dokumentationsgrundlage, keine
   Runtime-Geometrie.
2. Danach 411/412 pruefen: Firenze ist erster Stadt-Greybox-Kandidat, aber
   die `playable_city_area` bleibt eine abstrahierte Planungsgrundlage.
3. Danach 416 anwenden: Area Identity, Coordinate System, Metrics,
   Occupancy, Collision, Navigation, No-Walk/No-Build, Anchors und Visual-QA
   muessen als Standardfamilien geprueft werden.
4. Danach 415 anwenden: Stadtgrundflaeche, innere Spielbereiche, Wege, Arno/
   Fluss, Bruecken, Baukandidaten, Reserve, No-Walk, No-Build, Landmark- und
   Start-Anker muessen als Gate nachvollziehbar sein, bevor eine Stadt betreten
   werden darf.
5. Danach 417 v5 pruefen: Die runde 415-Erstform, v0/v1/v2-
   Zwischenrichtungen und die raeumlich/identitaetsseitig noch nicht
   ausreichenden v3-/v4-Zwischenstaende sind nicht ausreichend. Firenze braucht
   eine expanded Florence-shaped Ground Shape, 14 Parcel Candidates, 7
   Early-Use-, 4 Reserve-/Expansion- und 3 Special-/Landmark-nahe Parcels,
   Vegetationspuffer, organisches PATH-N/PATH-S, Branch/Future Paths, B1-B3
...
- Keine Firenze-City-Entry-App-Preview ist commitfaehig, wenn sie freie
  Bauplaetze, freie UI-Orte, frei gemalte Fluesse/Bruecken oder Marker ohne
  Anchor-Logik setzt.
- Keine Dokumentationsannahme aus 410, 411, 412, 415, 416 oder 417 darf als
  Runtime-Polygon, Koordinate, Collision, Build-Zone, Pathfinding,
  No-Walk-/No-Build-Maske, YAML/JSON, Asset, App-Route oder Persistenz gelesen
  werden.
- Kein Firenze-Folge-Slice ist commitfaehig, wenn er 417 v5 ignoriert, weniger
